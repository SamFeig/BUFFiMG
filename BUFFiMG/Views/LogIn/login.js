function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        //Validate value
        if(myInput.value == confirmMyInput.value&&myInput!="") {
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (letter.classList.contains('valid')&&match.classList.contains('valid')&&length.classList.contains('valid')&&number.classList.contains('valid')&&capital.classList.contains('valid')); // TODO: Replace false with the correct condition
    if(condition) {       
